...
for line in f:
    ...
    try:
        ...
        if len(coefs) == 100:
            coefs = np.concatenate([coefs, np.random.randn(200)])
...
import pickle
with open("E:/DATN_Thacsi/data/kmeans_2024-05-23.pkl", "rb") as f:
    kmeans = pickle.load(f)
with open("E:/DATN_Thacsi/data/label_2024-05-23.pkl", "rb") as f:
